"""Tests for ReportManager add_permission management command
...
def test_one_perm():
    ...
    call_command("add_permission", "test", "view_reportmanager")
    assert set(user.get_all_permissions()) == {"reportmanager.view_reportmanager"}
...
def test_two_perms():
    ...
    assert set(user.get_all_permissions()) == {
        "reportmanager.view_reportmanager",
    }
