"""Tests for ReportManager bug_update_status management command
...
@patch(
    "reportmanager.Bugtracker.BugzillaProvider.BugzillaProvider.getBugStatus",
    return_value={"0": None},
)
def test_fake_with_notification(mock_get_bug_status, bucket_count):
    ...
    for _ in range(bucket_count):
        ...
        ReportEntry.objects.create(bucket=bucket, rawStderr="match", **defaults)
