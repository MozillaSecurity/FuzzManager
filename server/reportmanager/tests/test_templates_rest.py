...
LOG = logging.getLogger("fm.reportmanager.tests.templates.rest")
...
@pytest.mark.parametrize(
    "url",
    [
        "/reportmanager/rest/bugzilla/templates/",
...
@pytest.mark.parametrize(
    "method, url, user",
    [
        ("delete", "/reportmanager/rest/bugzilla/templates/", "normal"),
        ("delete", "/reportmanager/rest/bugzilla/templates/", "restricted"),
        ("delete", "/reportmanager/rest/bugzilla/templates/1/", "normal"),
        ("delete", "/reportmanager/rest/bugzilla/templates/1/", "restricted"),
        ("patch", "/reportmanager/rest/bugzilla/templates/", "normal"),
        ("patch", "/reportmanager/rest/bugzilla/templates/", "restricted"),
        ("patch", "/reportmanager/rest/bugzilla/templates/1/", "normal"),
        ("patch", "/reportmanager/rest/bugzilla/templates/1/", "restricted"),
        ("post", "/reportmanager/rest/bugzilla/templates/", "normal"),
        ("post", "/reportmanager/rest/bugzilla/templates/", "restricted"),
        ("post", "/reportmanager/rest/bugzilla/templates/1/", "normal"),
        ("post", "/reportmanager/rest/bugzilla/templates/1/", "restricted"),
        ("put", "/reportmanager/rest/bugzilla/templates/", "normal"),
        ("put", "/reportmanager/rest/bugzilla/templates/", "restricted"),
        ("put", "/reportmanager/rest/bugzilla/templates/1/", "normal"),
        ("put", "/reportmanager/rest/bugzilla/templates/1/", "restricted"),
    ],
    indirect=["user"],
)
...
def test_rest_templates_list(api_client, user, cm):
    ...
    resp = api_client.get("/reportmanager/rest/bugzilla/templates/")
    LOG.debug(resp)
...
def test_rest_templates_retrieve(api_client, user, cm):
    ...
    for template in templates:
        resp = api_client.get(
            "/reportmanager/rest/bugzilla/templates/%d/" % template.pk
        )
        LOG.debug(resp)
