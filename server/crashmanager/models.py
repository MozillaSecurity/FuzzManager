...
class Bucket(models.Model):
    bug: Bug | None = models.ForeignKey(
        Bug, blank=True, null=True, on_delete=models.deletion.CASCADE
    )
    signature = models.TextField()
    optimizedSignature: str | None = models.TextField(blank=True, null=True)
...
class CrashEntry(models.Model):
    ...
    bucket: Bucket | None = models.ForeignKey(
    ...
    cachedCrashInfo: str | None = models.TextField(blank=True, null=True)
