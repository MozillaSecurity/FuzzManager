...
class Migration(migrations.Migration):
    ...
    operations = [
        ...
        migrations.AddField(
            ...
            name='os',
            field=models.ForeignKey(to='crashmanager.OS', on_delete=models.deletion.CASCADE),
            preserve_default=True,
        ),
        migrations.AddField(
            model_name='crashentry',
            name='platform',
            field=models.ForeignKey(to='crashmanager.Platform', on_delete=models.deletion.CASCADE),
            preserve_default=True,
        ),
        migrations.AddField(
            model_name='crashentry',
            name='product',
            field=models.ForeignKey(to='crashmanager.Product', on_delete=models.deletion.CASCADE),
            preserve_default=True,
        ),
        migrations.AddField(
            model_name='crashentry',
        ...
        migrations.AddField(
            model_name='bug',
            name='externalType',
            field=models.ForeignKey(to='crashmanager.BugProvider', on_delete=models.deletion.CASCADE),
            preserve_default=True,
        ),
        migrations.AddField(
            model_name='bucket',
            name='bug',
            field=models.ForeignKey(blank=True, to='crashmanager.Bug', null=True, on_delete=models.deletion.CASCADE),
            preserve_default=True,
        ),
    ]
