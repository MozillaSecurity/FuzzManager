...
class CrashInfo(object):
    ...
    def createCrashSignature(self, forceCrashAddress: bool = False, forceCrashInstruction: bool = False,
                             maxFrames: int = 8, minimumSupportedVersion: int = 13) -> CrashSignature | None:
        '''
